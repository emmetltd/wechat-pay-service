...
// +----------------------------------------------------------------------
// | github开源项目：https://github.com/emmtltd/wechat-pay-service/
// +----------------------------------------------------------------------
...
class WechatPay
{
    ...
    public function __construct($options = array())
    {
        ...
        $this->sub_mch_id = isset($this->config['sub_mch_id']) ? $this->config['sub_mch_id'] : '';
    ...
    protected function createXml($data)
    {
        ...
        if (!isset($data['submchid']) && !isset($data['sub_mch_id'])) {
    ...
    public function getPrepayId($openid, $body, $out_trade_no, $total_fee, $notify_url, $trade_type = "JSAPI", $goods_tag = null, $fee_type = 'CNY', $no_credit = null)
    {
        ...
        $result = $this->postXml($postdata, self::MCH_BASE_URL . '/pay/unifiedorder');
        return $result;
